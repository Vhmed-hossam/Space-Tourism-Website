export const CrewText = [
  ...
  },
  {
    crew: "Victor Glover",
    role: "Pilot",
    image: "/Extra/Crew/Crew 3.png",
    about: `Pilot on the second flight of the SpaceX Crew Dragon to the 
