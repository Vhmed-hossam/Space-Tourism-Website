...
export default function Sphere() {
  return (
    <div className="group rounded-full relative">
      <span className="absolute w-[135%] h-[135%] z-[-1] rounded-full bg-white left-[-16.5%] top-[-16.5%] opacity-0 group-hover:opacity-20 transition-all duration-500 ease-in-out" />
      <Link to="/destination">
        {" "}
